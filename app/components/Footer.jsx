            ...
            <form>
              <div class='relative'>
                <input
                  type='text'
                  id='voice-search'
                  class='bg-transparent rounded-full border ps-5 border-primary-800 text-red text-sm placeholder-primary-900 focus:text-white focus:outline-none block w-full p-2.5'
