        ...
        <h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-700 md:text-5xl lg:text-6xl'>
          {lostPet ? (
            <>
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-l to-red-600 from-red-400">Lost Pet</span> in this community.
            </>
          ) : (
            <>
              We help reunite{' '}
              <span className='text-transparent bg-clip-text bg-gradient-to-l to-primary-800 from-primary-500'> Found Pet</span> with
              their owners.
            </>
          )}
        </h1>
