...
import { TbHeart, TbShare, TbCirclePlus, TbBookmark, TbMapSearch, TbZoomMoney } from "react-icons/tb";
      ...
      <section class="bg-gray-50 py-8 antialiased md:py-12">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
            <div>
              <h2 class="mt-3 text-xl font-semibold text-gray-900 sm:text-2xl">Pet List</h2>
            </div>
            <div class="flex items-center space-x-4">
              ...
              <div id="dropdownSort1" class="z-50 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow" data-popper-placement="bottom">
                <ul class="p-2 text-left text-sm font-medium text-gray-500" aria-labelledby="sortDropdownButton">
                  <li>
                    <a href="#" class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900"> The most recent </a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
            ...
            {animalList.map(item => {
              return (
                <article key={item.id} class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <div class="pt-6">
                    <div class="mb-4 flex items-center justify-between gap-4">
                      ...
                      <div class="flex items-center justify-end gap-1">
                        ...
                        <button type="button" data-tooltip-target="tooltip-add-to-favorites" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900">
                          <span class="sr-only"> Add to Bookmark </span><TbBookmark className='h-5 w-5' />
                        </button>
                      </div>
                    </div>
                    ...
                    <div class="mt-2 flex items-center gap-2">
                      <p class="text-sm font-medium text-gray-900">Seen {item.dateLastSeen}</p>
                    ...
                    <ul class="mt-2 flex items-center gap-4">
                      ...
                      <li>
                        <button href={`https://www.google.com/maps/search/${item.ddLat}+${item.ddLon}`} class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900">
                          <span class="sr-only"> Localizar </span><TbMapSearch className='h-4 w-4' />
                        </button>
                      </li>
                    </ul>
                    <div class="mt-4 flex items-center justify-between gap-4">
                      <p class="text-2xl font-extrabold leading-tight text-gray-900 hidden">$1,699</p>
                      ...
                      <button type="button" class="inline-flex items-center rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100">
          ...
          <div class="w-full text-center">
            <button type="button" class="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100">
              Show more
            </button>
          </div>
        </div>
