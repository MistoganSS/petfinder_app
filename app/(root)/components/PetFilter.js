...
function PetFilter ({
  ...
  const handlers = {
    ...
    handleRewardChange,
    handleGenderChange,
    handleStartLastSeenChange,
    handleEndLastSeenChange
  }
  ...
  return (
    <form id='petFilter' className='hidden lg:block pe-4'>
      <h2 className='font-bold bg-gray-50 p-4 rounded-md'>
        Filter Lost & Found Pets
      </h2>
      <div className='border-b border-gray-200 py-6'>
        <h3 className='py-3 text-sm font-medium text-gray-900'>
          Last seen Pet
        </h3>
        <div
        ...
        >
          <div className='relative'>
            <input
              ...
              onChange={handleStartLastSeenChange}
              name='start'
              type='date'
          ...
          <div className='relative'>
            <input
              ...
              onChange={handleEndLastSeenChange}
              name='end'
              type='date'
              className='bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5'
      ...
      <div className='border-b border-gray-200 py-6'>
        <h3 className='pb-3 text-sm font-medium text-gray-900'>
          Minimum reward
        </h3>
        <div className='relative mb-6'>
          ...
          />
          <span className='text-xs text-gray-400 absolute start-0 -bottom-6'>
            Min ($0)
          </span>
          <span className='text-xs text-gray-400 absolute start-1/3 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6'>
            $500
          </span>
          <span className='text-xs text-gray-400 absolute start-2/3 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6'>
            $1000
          </span>
          <span className='text-xs text-gray-400 absolute end-0 -bottom-6'>
            Max ($1500)
          </span>
        </div>
      </div>
